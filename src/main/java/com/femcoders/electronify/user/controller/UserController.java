...
public class UserController {
    ...
    public ResponseEntity<UserWithReviewsResponse> getUserById(@Parameter(description = "User ID")@PathVariable Long id) {
    ...
    public ResponseEntity<UserResponse> updateUser(@Parameter(description = "User ID you want to update") @PathVariable Long id, @Valid @RequestBody UserRequest request) {
    ...
    public ResponseEntity<Void> deleteUser(@Parameter(description = "User ID you want to delete") @PathVariable Long id) {
